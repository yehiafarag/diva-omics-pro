 ...
 * @author Yehia Farag
 */
public class TopTreeImg extends Image implements MouseMoveHandler, MouseOutHandler {
    ...
    public TopTreeImg(String url, ClientClusterNode node, int type,HTML toolTip,int squareL) {
        super(url);
        this.squareL = squareL;
        this.toolTip = toolTip ;
        toolTip.setVisible(false);
        this.addMouseMoveHandler(TopTreeImg.this);
        this.addMouseOutHandler(TopTreeImg.this);
        this.mainNode = node;
        this.type = type;
