...
public class SomClustView extends ModularizedListener {
    ...
    public SomClustView(SomClusteringResult somClusteringResults, SelectionManager selectionManager, GreetingServiceAsync greetingService, int width, int height, boolean clustColumn) {
