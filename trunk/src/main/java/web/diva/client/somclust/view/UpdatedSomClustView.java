...
public class UpdatedSomClustView extends ModularizedListener {
    ...
    public UpdatedSomClustView(SomClusteringResult somClusteringResults, SelectionManager selectionManager, DivaServiceAsync DivaClientService,boolean clusterColumn) {
        ...
        mainClusteringPopupBodyLayout.setWidth(99 + "%");
        mainClusteringPopupBodyLayout.setHeight(60+"%");
...
//                Window.open(thumbChart.getUrl(), "Download Image", "menubar=yes,location=yes,resizable=yes,scrollbars=yes,status=yes,toolbar=true, width=" + Window.getClientWidth() + ",height=" + Window.getClientHeight());
        ...
        if (clusterColumn) {
            ...
            maxSpacer2.setSize((10 + "px"), (70 + "px"));
            ...
            maxTopClusterLayout.setCellWidth(maxSpacer2, "10px");
        } else {
...
//            maxBottomClusterLayout.setCellWidth(maxUpperTreeImg, maxUpperTreeImg.getWidth() + "px");
    ...
    private void initMaxmizeLayout(SomClusteringResult somClusteringResults, int rotateSpacerFactor) {
        ...
        maxInteractiveColImage.setUrl("images/w.png");
        maxScaleImg.setUrl(somClusteringResults.getScaleImgUrl());

        maxMiddleClusterLayout.setWidth("20%");
        maxInteractiveColImage.setSize("10px", sideTreeImg.getHeight() + "px");
        ...
        maxMiddleClusterLayout.setCellWidth(maxInteractiveColImage, "10px");
